        ...
        <form action="translate" method="post">
            ...
            <table>
                ...
                <c:if test = "${! empty  w1.getEng()}">
                    <td>
                        <%out.print(w1.getLoaitu() + "");%><br>
                        <%out.print("Ví dụ: " + w1.getViduv() + "");%><br>
                        <%out.print("Example: " + w1.getVidue() + "");%><br>
                        <input type="submit" name="star1" value="Star">
                    </td>                   
                </c:if>    

                <tr><td> <%out.print(c1);%></td></tr>
                ...
                <c:if test = "${!empty w2.getVie() }">
                    <td><%out.print(w2.getLoaitu());%><br>
                        ...
                        <%out.print("Example: " + w2.getVidue());%><br>
                        <input type="submit" name="star2" value="Star">
                    </td>                   
                </c:if>
                <tr> <td><%out.print(c2);%></td></tr>
